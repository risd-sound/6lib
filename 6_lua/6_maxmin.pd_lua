...
-- s3g 2016
-- an object for finding the min and max values in a table

local Maxmin = pd.Class:new():register("6_maxmin")

function Maxmin:initialize(name, atoms)
--  pd.post("6_maxmin")
  self.inlets = 1
  self.outlets = 1
  return true
...
function Maxmin:in_1(sel, atoms)
      self:outlet(1, "list", {stats.maxmin(atoms)})
end
